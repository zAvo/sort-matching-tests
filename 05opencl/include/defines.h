...
/** \brief Define for choosing the target video card producer.
*/
#define VIDEO_CARD_VENDOR			"NVIDIA Corporation"
//#define VIDEO_CARD_VENDOR			"Advanced Micro Devices, Inc."
...
/** \brief the length of the video card vendor name
*/
#define VENDOR_NAME_SIZE			50	


/** \brief The file containing the OpenCL program.
*/
#define PROGRAM_FILE				"program.cl"


/** \brief The name of the kernel who performs the bitwise NOT on the vector.
*/
#define KERNEL_BITWISE_NOT			"vector_bitwise_not"


/** \brief The name of the kernel who performs the bitwise OR on the vectors.
*/
#define KERNEL_BITWISE_OR			"vector_bitwise_or"


#ifdef __VERBOSE
/** \brief Maximum size of the build log of the OpenCL compiler.
*/
#define BUILD_LOG_SIZE_MAX			2500
#endif // __VERBOSE


/** \brief Number of local working sets of an NDRange kernel.
*/
#define LOCAL_WS					512


/**	\brief Macro that calculates the number of global working sets of an NDRange kernel.

The resulting value is the smallest multiple of LOCAL_WS bigger than size.
*/
#define GLOBAL_WS(_size)			( LOCAL_WS * ((_size + LOCAL_WS) / LOCAL_WS) )
